...
export default function AlbumaPage() {
  ...
  useEffect(() => {
    const fetchDurations = async () => {
      if (!album?.songs) return; // Ensure album.songs exists before proceeding
      ...
      const fetchedDurations = await Promise.all(
        album.songs.map((song) => {
          return new Promise((resolve) => {
            ...
            audio.addEventListener("error", () => resolve(0)); // Handle errors gracefully
          });
        })
      );
                  ...
                  <div className="relative z-10">
                    <div className="flex p-6 pb-8 gap-6">
                      ...
                      <div className="flex flex-col justify-end">
                        ...
                        <div className="flex item-center gap-2 text-zinc-100 text-sm">
